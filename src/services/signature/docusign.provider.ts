...
export async function createEnvelope({ contract, landlord, tenant, embedded }: CreateEnvelopeArgs): Promise<{ envelopeId: string; status: 'created'|'sent'; recipientUrls?: { landlordUrl?: string; tenantUrl?: string } }> {
